            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="dropdown d-flex justify-content-end me-5">
                        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" name="addMarks">Add Tests</button>
                        <ul class="dropdown-menu" id="thenumbers" name="thenumbers" aria-labelledby="dropdownMenuButton1">
                            <li class="dropdown-item" value="test" style="cursor:pointer" ><a href="../teachers/addmarks.php? semester=<?php echo $semester;?> && assaigncourse_id=<?php echo $assaigncourse_id;?> && test_type=classTest">Class Test</a></li>
                            <li class="dropdown-item" value="Presentation" style="cursor:pointer" ><a href="addmarks.php?semester=<?php echo $semester;?> && assaigncourse_id=<?php echo $assaigncourse_id;?> && test_type=presentation"> Presentation</a></li>
                            <li class="dropdown-item" value="Assignment" style="cursor:pointer" ><a href="addmarks.php?semester=<?php echo $semester;?> && assaigncourse_id=<?php echo $assaigncourse_id;?> && test_type=assignment"> Assignment</a></li>
                        </ul>
