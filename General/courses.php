...
<div class="course_div">
    <div class="courses_main_div">
        ...
        <a href="../Semester/Semesters.php?action=secondsemester"><svg>
                <rect></rect>
            </svg>2nd Semester</a>
    </div>
    <div class="courses_main_div">
        <a href="../Semester/Semesters.php?action=thirdsemester"><svg>
                <rect></rect>
            </svg>3rd Semester</a>
        <a href="../Semester/Semesters.php?action=forthsemester"><svg>
                <rect></rect>
            </svg>4th Semester</a>
    </div>
    <div class="courses_main_div">
