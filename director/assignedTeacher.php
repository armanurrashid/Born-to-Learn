...
if(isset(($_GET['teacher_id']))){ 
    ...
    if ($assaignedCourse ->num_rows > 0) {
        $assaignedTeacher = mysqli_query($conn, " SELECT * FROM `assaigncourse` WHERE year='$year' AND teacher_id='$teacher_id' AND semester='$semester'") or die
        ('query failed');
        ...
        <table>
            <tbody>
                ...
                if ($result->num_rows > 0) {?>
                    ...
                    <tr id="semester"> 
                      <th colspan="5" style="text-align:center;">1<sup>st</sup> Semester</th>
                    </tr>
                  ...
                  <?php  while ($row = $result->fetch_assoc()) {
                     ...
                     ?>
                        ...
                        <td><div class="dropdown d-flex justify-content-center">
                ...
                <?php 
                  $assaignedTeacher = mysqli_query($conn, " SELECT * FROM `assaigncourse` WHERE year='$year' AND course_id='$course_id'") or die('query failed');
                     if ($assaignedTeacher->num_rows > 0) {
                        ...
                        $ateacher_name="Not Assigned any eacher For this Course";
                    }?>

                    <h6><?php echo $ateacher_name; ?></h6>
