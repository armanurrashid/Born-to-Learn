        ...
        <div class="row mx-5">
            ...
            if ($semester_Course->num_rows > 0) {
                ...
                while ($row = $semester_Course->fetch_assoc()) {
                    ...
                    // $course = mysqli_query($conn, " SELECT * FROM `courses` WHERE course_semester='$user_semester") or die('query failed');
                    ...
                    <div class="col-3 d-flex justify-content-around">
                        <div class="card mb-4" style="width: 18rem;background:#d5e5f6 ">
                            <div class="card-body" style="text-align:center;">
                                ...
                                <div>
                                    <a href="../teachers//coursePerformance.php?semester=<?php echo $user_semester; ?> && assaigncourse_id=<?php echo $assaigncourse_id; ?> " class="card-link btn button_color btn-sm text-white mt-2">See Performance</a>
                                </div>
                            </div>
                        </div>
                    </div>
